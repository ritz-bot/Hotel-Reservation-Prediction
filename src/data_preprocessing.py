...
class DataProcessor:
    ...
    def __init__(self, train_path, test_path, processed_dir, config_path):# constructor for the class, train path - from wehere to get data, processed dir - store data
        self.train_path = train_path
        self.test_path = test_path
        self.processed_dir = processed_dir

        self.config = read_yaml(config_path)#reads yaml file and stores in self.coonfig

        if not os.path.exists(self.processed_dir):
            os.makedirs(self.processed_dir)
        
    
    def preprocess_data(self,df):# df is the dataframe
        try:
            ...
            # define categorical and numerical columsn which you are going to extract from yaml file.
            ...
            skewness = df[num_cols].apply(lambda x:x.skew())# numerical columns pr hi skewness lagti , categorical columns dont have any of numbers
